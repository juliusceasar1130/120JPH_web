...
export const constantRoute = [
    ...
    },
    {
        ...
        children: [
            {
                path: '/skid/home',
                component: () => import('@/views/skid/home/index.vue'),
                name: 'skidhome',
                meta: {
                    title: '雪橇一览表',//菜单需要标题
                    hidden: false,
            ...
            },  
            {
                ...
                component: () => import('@/views/skid/history-clean/index.vue'),
                name: 'skidhistoryclean',
                meta: {
                    title: '清洁度历史',//菜单需要标题
                    hidden: true,
                    icon: "Brush"
            ...
            },
            {
                ...
                component: () => import('@/views/skid/history-status/index.vue'),
                name: 'skidhistorystatus',
                meta: {
                    title: '上下线历史',//菜单需要标题
                    hidden: true,
                    icon: "Switch"
