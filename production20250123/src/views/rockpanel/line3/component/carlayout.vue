    ...
    <el-row>
      ...
      <el-col :span="16">
        ...
        <div class="carlayout">
          <!--上部区域-->
          <div class="top">
            <el-result :icon="rightrecord == 'good' ? 'success' : 'error'"></el-result>
          </div>
          <!--图片区域-->
          <div class="img"></div>
          <!--下部区域-->
          <div class="bottom">
            <el-result :icon="leftrecord == 'good' ? 'success' : 'error'"></el-result>
          </div>
        </div>
      </el-col>
...
import { reqLine3LastRecord } from '@/api/rockpanel'
...
const getlastRecord = async () => {
  const res = await reqLine3LastRecord()
